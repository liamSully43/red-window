...
export class RedComponent implements OnInit {
  ...
  noResults = {
    state: false,
    message: "That's it, there's no more red photos available",
  };
  page = 1;
  ...
  ngOnInit(): void {
    document.querySelector("title").innerHTML = "Red Window - Red";
    let search = null;
    search = () => {
      fetch(`https://api.unsplash.com/search/photos/?&query=red&per_page=30&page=${this.page}&order_by=popular&color=red`, {
        "method": "GET",
        headers: {
